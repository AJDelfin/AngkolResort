...
<body class="font-sans antialiased bg-cream text-gray-800">
        ...
        <?php if(Route::has('login')): ?>
            <div class="space-x-4 text-sm font-semibold">
                ...
                <?php if(auth()->guard('web')->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="hover:text-primary transition">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="hover:text-primary transition">Log in</a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="bg-primary px-4 py-2 rounded-md hover:bg-green-800 transition">Sign Up</a>
                    <?php endif; ?>
                <?php endif; ?>

                <!-- ADMIN -->
                <?php if(auth()->guard('admin')->check()): ?>
                    <a href="<?php echo e(url('/admin/dashboard')); ?>" class="hover:text-primary transition">Admin Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('admin.login')); ?>" class="hover:text-primary transition">Admin</a>
                <?php endif; ?>

                <!-- STAFF (Formerly Teacher) -->
                <?php if(auth()->guard('teacher')->check()): ?>
                    <a href="<?php echo e(url('/teacher/dashboard')); ?>" class="hover:text-primary transition">Staff Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('teacher.login')); ?>" class="hover:text-primary transition">Staff</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </nav>
    ...
    <section class="relative h-[65vh] w-full overflow-hidden">
        ...
        <img 
            src="<?php echo e(asset('images/image4.jpg')); ?>" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-3">
                            <div class="h-48 w-full overflow-hidden rounded-lg">
                                <img src="<?php echo e(asset('images/image2.jpg')); ?>" alt="Day Tour Pool" class="w-full h-full object-cover transition duration-300 hover:scale-105">
                            </div>
                        ...
                        <div class="space-y-3">
                            <div class="h-48 w-full overflow-hidden rounded-lg">
                                <img src="<?php echo e(asset('images/image3.jpg')); ?>" alt="Camping" class="w-full h-full object-cover transition duration-300 hover:scale-105">
                            </div>
                        ...
                        <div class="space-y-3 md:col-span-2">
                            <div class="h-64 w-full overflow-hidden rounded-lg">
                                <img src="<?php echo e(asset('images/image5.jpg')); ?>" alt="Rooms and Huts" class="w-full h-full object-cover transition duration-300 hover:scale-105">
                            </div>
...
</html><?php /**PATH D:\FileHistory\laravel-11-multi-auth-mainANGKOL RESORT\resources\views/welcome.blade.php ENDPATH**/ ?>